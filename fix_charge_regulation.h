...
class Fix_charge_regulation : public Fix {
 public:
  ...
  void forward_salt();
  void backward_salt();
  double insert_particle(int,double);
  double* delete_particle(int,double);
  double* delete_particle_salt(int,double);
  double insert_particle_cutoff(int,double,double *);
  double* delete_particle_cutoff(int,double, double *);
 ...
 private:
  ...
  double pKa,lb,pKb,pH,pI_plus,pI_minus;
